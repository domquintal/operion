...
# Real starter resolved at shim creation time (single-quoted literal):
...
try {
  if ($ext -eq ".ps1") {
    ...
    & "C:\WINDOWS\System32\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -ExecutionPolicy Bypass -File $Real 2>&1 |
      ForEach-Object {
